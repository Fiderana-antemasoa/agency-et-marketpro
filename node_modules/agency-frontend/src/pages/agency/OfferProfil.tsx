...
export default function OfferProfile() {
  ...
  useEffect(() => {
    const fetchOffer = async () => {
      try {
        ...
        const offerData = res.data as any;
        if (offerData.price !== undefined && offerData.price !== null && offerData.price !== "") {
          const rawPrice = typeof offerData.price === "number" ? offerData.price : parseFloat(offerData.price);
          const numericPrice = isNaN(rawPrice) ? undefined : Math.max(0, rawPrice);
          offerData.price = numericPrice;
        } else {
          offerData.price = undefined;
        }
        setOffer(offerData);
        setFormData({ ...offerData, localisation: offerData.localisation || "" });
      } catch (error) {
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await axios.put<Offer>(`${API_URL}/${id}`, {
        ...formData,
        localisation: (formData as any).localisation
      });
      setOffer(res.data);
                ...
                {isEditing ? (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              setFormData({
                                ...formData,
                                price: isNaN(numeric) ? undefined : Math.max(0, numeric),
                              });
                            }}
                            className="mt-1"
                          />
                    ...
                    <div className="space-y-4">
                      ...
                      {/* la disponibilité en mode lecture s'affichera ici */}
                    ...
                    {/* pour editer le champ disponibilité */}
                    <div>
                      <Label htmlFor="localisation" className="text-sm font-medium">
                        Disponibilité <span className="text-red-500">*</span>
                      </Label>
                      <Select
                        value={(formData as any).localisation || ""}
                        onValueChange={(value) => setFormData(prev => ({ ...prev, localisation: value } as any))}
                      >
                        ...
                        <SelectContent position="popper" sideOffset={8} className="z-[9999] max-h-96">
                          {[
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center gap-3 p-3 bg-muted/30 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="font-medium">{(offer as any).localisation || "Non renseigné"}</p>
                        </div>
                      </div>
